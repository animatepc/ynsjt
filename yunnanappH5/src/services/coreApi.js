...
export const coreApi = {
  api: {
    ...
    deleteMyShoot:sms+'myVideo/delete.do',
    ...
    changeAvatar:sms+'home/info/changeAvatar.do',
  ...
  getMyCollectionList(body){
    return HttpService.post(this.api.getMyCollectionList, body, false, true)
  },
  //我的-->我的收藏-->清空
  ...
  getMyRecordHistList(body){
    return HttpService.post(this.api.getMyRecordHistList, body, false, true)
  },
  //我的-->我的收藏-->列表
  clearAllHistory(body){
    return HttpService.post(this.api.clearAllHistory, body, false, true)
  },
  //我的-->我的我拍-->列表
  getMyVideoList(body){
  return HttpService.post(this.api.myVideoList, body, false, true)
  },
  // 我的-->我的我拍-->删除
  deleteMyShoot(body){
    return HttpService.post(this.api.deleteMyShoot,body,false,false)
  },
  //我的-->个人信息-->修改用户名
  updateUserName(body){
  ...
  //个人中心-->我的消息
  gethomeMessage(body){
    return HttpService.post(this.api.homeMessage, body, false, true)
  }, 
  //我的-->我的积分-->我的积分上半部分
  ...
  //我的-->我的积分-->积分规则
  getPointList(body){
    return HttpService.post(this.api.getPointList, body, false, true)
  },
  //退出登录
  logOff(body){
  ...
  //我的-->账户设置主页
  userSetIndex(body){
    return HttpService.get(this.api.userSetIndex, body, false, false) 
  },
  //我的-->绑定手机号-->发送验证码
  bindingMobile(body){
    return HttpService.get(this.api.bindingMobile, body, false, false) 
  },
  //我的-->绑定手机号-->手机号+验证码验证码
  ...
  uploadLocalImage(body){
    return HttpService.postForm(this.api.uploadLocalImage, body, false)
  },
  changeAvatar(body){
    return HttpService.post(this.api.changeAvatar,body,false,false)
  },
  //个人中心-->意见反馈-->添加反馈
  getaddFeedback(body){
  ...
  //个人中心获取当前登录用户
  getInfoUser(){
  return HttpService.post(this.api.getInfoUser, {}, false, true)
  }
}
