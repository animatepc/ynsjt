...
export const videoApi = {
  ...
  //短视频
  video(body){
    return HttpService.post(this.api.video, body, true, true)
  },
  //推荐位
  recom(body){
  ...
  return HttpService.post(this.api.columnVideoList, body, false, true)
  },
  //视频-->品牌栏目-->栏目数据
  ...
  //视频-->品牌栏目-->频道、节目-->详情
  channelList(body){
  return HttpService.post(this.api.channelList, body, false, true)
  },
  //所有节目剧集
  commonList(body){
  return HttpService.post(this.api.commonList, body, false, true)
  }
}
