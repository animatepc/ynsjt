<template>
    <div class="myCollection _cus_flexContent _cus_direction">
        ...
        <scroller v-if="newMsg.length > 0" style="height: calc(100vh - 1rem)"  :types="'myCollection'" class="newsMessage_content bgfff" @pullDown="selPulldown" @pullUp="selPullup" :scrollerMsg="scrollerMsg" :dataList="newMsg" ref="scroller"></scroller>
        <span v-else   class="Block perW100 _cus_textCenter">您还没有收藏过~</span>
        <confirm
            class="login_alert"
            :value="hide_alert"
            button-text="确认"
