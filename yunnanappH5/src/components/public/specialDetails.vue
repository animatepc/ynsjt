<template>
    <div class="special_details perH100">
        ...
        <div class="videodetails_video _cus_posRelative">
            <div class="video">
            	<img v-lazy="newsdetails_msg.projectMainImg" :key="newsdetails_msg.projectMainImg" alt="" />
            </div>
	            ...
	            <div class="_cus_overHidden">
	                <p class="_cus_flexContent _cus_jusContent _cus_fleAlignCen _cus_overHidden">
	                    ...
	                    <span class="_cus_flexContent _cus_fleAlignCen">
		                    ...
		                    <span class="__cus_fl" @click="isIcon = !isIcon">简介 </span>
          ...
          > li {
            ...
            .tabImg {
              ...
              > .video_playicon {
                ...
                margin-top: -0.58rem;
                margin-left: -0.58rem;
                background: url(../../../static/imgs/playicon.png) no-repeat
                  left center;
                background-size: 100%;
                z-index: 2;
              }
