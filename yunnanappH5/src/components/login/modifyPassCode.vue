    ...
    <div class="modifyPassCode">
        ...
        <div class="setphone_content bgfff">
            <p class="perW100 _cus_textCenter setphone_tip">
                已向手机号 <span v-if="$router.currentRoute.query.mobile">{{$router.currentRoute.query.mobile}}</span>  发送验证码
            </p>
             <div class="login_code _cus_flexContent _cus_jusContent">
                ...
                <x-Button :disabled="xbuttondis" type="button" class="" :class="!xbuttondis?'login_xbtn':'login_disabled'" @click.native="xbtn_setinter">{{xbtn_msg}}</x-Button>
            </div>
        </div>
